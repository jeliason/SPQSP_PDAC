...
public:
	...
	bool voxelIsOpen(const Coord& c, AgentType type)const;
	...
	int get_sizeX() const { return _sizeX; }
	int get_sizeY() const { return _sizeY; }
	int get_sizeZ() const { return _sizeZ; }
